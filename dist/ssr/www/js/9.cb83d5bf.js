...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/comments/Index.vue?vue&type=template&id=77f3fc66&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-page',{staticClass:"q-px-md q-pt-lg"},[_c('div',{staticClass:"page-heading text-white q-pa-md"},[_c('div',{staticClass:"heading-caption"},[_c('h6',[_vm._v("Comments")]),_c('br'),_c('p',[_vm._v("The following are product comments posted by customers.")])])]),_c('div',{staticClass:"page-contents text-white q-pa-md"},[_c('div',{staticClass:"content-1"},[_c('q-input',{staticClass:"filter-search-box",attrs:{"type":"search","placeholder":"Search product","debounce":"500","dark":"","dense":"","outlined":""},on:{"input":_vm.searchInput},scopedSlots:_vm._u([{key:"prepend",fn:function(){return [_c('q-icon',{attrs:{"name":"search"}})]},proxy:true},{key:"append",fn:function(){return [_c('transition',{attrs:{"name":"fade"}},[_c('q-icon',{directives:[{name:"show",rawName:"v-show",value:(_vm.search != ''),expression:"search != ''"}],staticClass:"cursor-pointer",attrs:{"name":"close"},on:{"click":_vm.searchClear}})],1)]},proxy:true}]),model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_c('div',{staticClass:"content-2"},[_c('q-table',{staticClass:"comments-table",attrs:{"grid":"","row-key":"id","data":_vm.data,"columns":_vm.columns,"rows-per-page-options":[0],"pagination":_vm.pagination,"filter":_vm.search,"loading":_vm.loading},on:{"update:pagination":[function($event){_vm.pagination=$event},_vm.onChgPage],"request":_vm.onRequest},scopedSlots:_vm._u([{key:"item",fn:function(props){return [_c('div',{staticClass:"q-pa-xs col-xs-12 col-sm-6 col-md-4 col-lg-4"},[_c('q-card',{staticClass:"bg-gray-alpha-2"},[_c('q-card-section',{staticClass:"comment-text"},[_vm._v("\n                                "+_vm._s(props.row.text)+"\n                            ")]),_c('q-separator'),_c('q-list',{attrs:{"dense":""}},_vm._l((props.cols.filter(
                                        function (col) { return col.name !== 'text'; }
                                    )),function(col){return _c('q-item',{key:col.name},[_c('q-item-section',[_c('q-item-label',[_vm._v(_vm._s(col.label))])],1),_c('q-item-section',{attrs:{"side":""}},[_c('q-item-label',{staticClass:"text-primary"},[_vm._v(_vm._s(col.value))])],1)],1)}),1),_c('q-separator'),_c('q-card-actions',{attrs:{"align":"right"}},[_c('q-btn',{attrs:{"dense":"","flat":"","round":"","icon":"reply","to":'/comments/reply/' + props.row.id}},[_c('q-tooltip',{attrs:{"anchor":"bottom right","self":"top middle","offset":[10, 10]}},[_vm._v("Reply to comment\n                                    ")])],1),_c('q-btn',{attrs:{"dense":"","flat":"","round":"","icon":props.row.flagged
                                            ? 'flag'
                                            : 'outlined_flag'},on:{"click":function($event){return _vm.confirmAction(
                                            props.row.id,
                                            !props.row.flagged
                                        )}}},[_c('q-tooltip',{attrs:{"anchor":"bottom right","self":"top middle","offset":[10, 10]}},[_vm._v("\n                                        "+_vm._s(props.row.flagged
                                                ? "Unflag"
                                                : "Flag")+"\n                                        comment\n                                    ")])],1)],1)],1)],1)]}}])}),_c('ConfirmDialog',{attrs:{"showDlg":_vm.showDlg},on:{"update:showDlg":function($event){_vm.showDlg=$event},"update:show-dlg":function($event){_vm.showDlg=$event}},scopedSlots:_vm._u([{key:"avatar",fn:function(){return [_c('q-avatar',{attrs:{"icon":"report_problem","color":"red-5","text-color":"white"}})]},proxy:true},(_vm.targetFlagVal)?{key:"message",fn:function(){return [_vm._v("\n                    This action will mark this comment as "),_c('u',[_vm._v("FLAGGED")]),_vm._v(".\n                    "),_c('br'),_vm._v("\n                    Comment will no longer be visible in the product page.\n                ")]},proxy:true}:{key:"message",fn:function(){return [_vm._v("\n                    This action will "),_c('u',[_vm._v("UNFLAG")]),_vm._v(" this comment. "),_c('br'),_vm._v("\n                    Comment will be visible again in the product page.\n                ")]},proxy:true},{key:"actions",fn:function(){return [_c('q-btn',{directives:[{name:"close-popup",rawName:"v-close-popup"}],attrs:{"flat":"","label":"Cancel"}}),_c('q-btn',{directives:[{name:"close-popup",rawName:"v-close-popup"}],attrs:{"flat":"","label":"Proceed","color":"red-5"},on:{"click":_vm.onProceed}})]},proxy:true}],null,true)})],1)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/comments/Index.vue?vue&type=template&id=77f3fc66&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/comments/Index.vue?vue&type=script&lang=js&
  ...
  methods: {
    ...
    onRequest(props) {
      ...
      return asyncToGenerator_default()(function* () {
        ...
        try {
          const resp = yield Comment.getComments();
          _this.original = resp;
          _this.data = _this.original.slice();
        } catch (err) {
          _this.showNotif(false, "Could not retrieve comments. ");
        } finally {
          _this.loading = false;
        }
      })();
    ...
    onProceed() {
      ...
      return asyncToGenerator_default()(function* () {
        if (_this2.toFlagID !== -1) {
          try {
            // Toggle flag comment
            const resp = yield Comment.flagComment(_this2.toFlagID, _this2.targetFlagVal);

            _this2.showNotif(true, _this2.targetFlagVal ? "Comment has been FLAGGED." : "Comment has been UNFLAGGED."); // Update


            _this2.data.forEach(el => {
              if (el.id === _this2.toFlagID) {
                el.flagged = _this2.targetFlagVal;
              }
            }); // Reset


            _this2.toFlagID = -1;
            _this2.targetFlagVal = false;
          } catch (err) {
            _this2.showNotif(false, "Could not update item. ");
          }
        }
      })();
    }
...
// CONCATENATED MODULE: ./src/pages/comments/Index.vue?vue&type=script&lang=js&
 /* harmony default export */ var comments_Indexvue_type_script_lang_js_ = (Indexvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/pages/comments/Index.vue?vue&type=style&index=0&id=77f3fc66&lang=scss&scoped=true&
var Indexvue_type_style_index_0_id_77f3fc66_lang_scss_scoped_true_ = __webpack_require__("fe3d");

// EXTERNAL MODULE: ./src/pages/comments/Index.vue?vue&type=style&index=1&lang=scss&
var Indexvue_type_style_index_1_lang_scss_ = __webpack_require__("5930");
...
// CONCATENATED MODULE: ./src/pages/comments/Index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  comments_Indexvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
runtime_auto_import_default()(component, 'components', {QPage: QPage["a" /* default */],QInput: QInput["a" /* default */],QIcon: QIcon["a" /* default */],QTable: QTable["a" /* default */],QCard: QCard["a" /* default */],QCardSection: QCardSection["a" /* default */],QSeparator: QSeparator["a" /* default */],QList: QList["a" /* default */],QItem: QItem["a" /* default */],QItemSection: QItemSection["a" /* default */],QItemLabel: QItemLabel["a" /* default */],QCardActions: QCardActions["a" /* default */],QBtn: QBtn["a" /* default */],QTooltip: QTooltip["a" /* default */],QAvatar: QAvatar["a" /* default */]});runtime_auto_import_default()(component, 'directives', {ClosePopup: ClosePopup["a" /* default */]});
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_77f3fc66_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("7499");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_77f3fc66_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_77f3fc66_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_77f3fc66_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ })

}]);
//# sourceMappingURL=9.cb83d5bf.js.map