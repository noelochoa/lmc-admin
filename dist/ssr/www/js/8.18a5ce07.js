...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/categories/Index.vue?vue&type=template&id=b7444de4&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-page',{staticClass:"q-px-md q-pt-lg"},[_c('div',{staticClass:"page-heading text-white q-pa-md"},[_c('div',{staticClass:"heading-caption"},[_c('h6',[_vm._v("Product Categories")]),_c('br'),_c('p',[_vm._v("\n                The following are product categories visible in the\n                webstore.\n            ")])])]),_c('div',{staticClass:"page-contents text-white q-pa-md"},[_c('div',{staticClass:"content-1"},[_c('q-btn',{staticClass:"q-mr-sm",attrs:{"flat":"","round":"","icon":"post_add","to":"/categories/add"}},[_c('q-tooltip',{attrs:{"anchor":"bottom right","self":"top middle","offset":[10, 10]}},[_vm._v("Add New Category")])],1),_c('q-input',{staticClass:"filter-search-box",attrs:{"type":"search","placeholder":"Search category","debounce":"500","dark":"","dense":"","outlined":""},on:{"input":_vm.searchInput},scopedSlots:_vm._u([{key:"prepend",fn:function(){return [_c('q-icon',{attrs:{"name":"search"}})]},proxy:true},{key:"append",fn:function(){return [_c('transition',{attrs:{"name":"fade"}},[_c('q-icon',{directives:[{name:"show",rawName:"v-show",value:(_vm.search != ''),expression:"search != ''"}],staticClass:"cursor-pointer",attrs:{"name":"close"},on:{"click":_vm.searchClear}})],1)]},proxy:true}]),model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_c('div',{staticClass:"content-2"},[_c('q-table',{staticClass:"categories-table",attrs:{"square":"","row-key":"id","data":_vm.data,"columns":_vm.columns,"pagination":_vm.pagination,"rows-per-page-options":[0],"loading":_vm.loading,"filter":_vm.search,"binary-state-sort":""},on:{"update:pagination":[function($event){_vm.pagination=$event},_vm.onChgPage],"request":_vm.onRequest},scopedSlots:_vm._u([{key:"body",fn:function(props){return [_c('q-tr',{attrs:{"props":props}},[_c('q-td',{key:"category",attrs:{"props":props}},[_vm._v(_vm._s(props.row.category))]),_c('q-td',{key:"created",attrs:{"props":props}},[_vm._v(_vm._s(props.row.created))]),_c('q-td',{key:"count",attrs:{"props":props}},[_vm._v(_vm._s(props.row.count))]),_c('q-td',[_c('q-btn',{staticClass:"q-mr-sm",attrs:{"dense":"","flat":"","round":"","icon":"build","to":'/categories/edit/' + props.row.id}},[_c('q-tooltip',{attrs:{"anchor":"center right","self":"center left","offset":[10, 10]}},[_vm._v("Edit Category")])],1),_c('q-btn',{attrs:{"dense":"","flat":"","round":"","disabled":props.row.count > 0,"icon":"delete"},on:{"click":function($event){return _vm.confirmDel(props.row.id)}}},[_c('q-tooltip',{attrs:{"anchor":"bottom right","self":"top middle","offset":[10, 10]}},[_vm._v("Delete Category\n                                ")])],1)],1)],1)]}}])}),_c('ConfirmDialog',{attrs:{"showDlg":_vm.showDlg},on:{"update:showDlg":function($event){_vm.showDlg=$event},"update:show-dlg":function($event){_vm.showDlg=$event}},scopedSlots:_vm._u([{key:"avatar",fn:function(){return [_c('q-avatar',{attrs:{"icon":"delete_forever","color":"red-5","text-color":"white"}})]},proxy:true},{key:"message",fn:function(){return [_vm._v("\n                    Continue on removing this category?"),_c('br'),_vm._v("\n                    Warning: Can not delete categories with products.\n                ")]},proxy:true},{key:"actions",fn:function(){return [_c('q-btn',{directives:[{name:"close-popup",rawName:"v-close-popup"}],attrs:{"flat":"","label":"Cancel"}}),_c('q-btn',{directives:[{name:"close-popup",rawName:"v-close-popup"}],attrs:{"flat":"","label":"Remove","color":"red-5"},on:{"click":_vm.onRemove}})]},proxy:true}])})],1)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/categories/Index.vue?vue&type=template&id=b7444de4&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.transform-quasar-imports.js!./node_modules/babel-loader/lib??ref--2-0!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/categories/Index.vue?vue&type=script&lang=js&
  ...
  methods: {
    ...
    onRequest(props) {
      ...
      return asyncToGenerator_default()(function* () {
        ...
        try {
          const resp = yield Category.getAllCategories();
          _this.original = resp;
          _this.data = _this.original.slice();
        } catch (err) {
          _this.showNotif(false, "Could not retrieve categories. ");
        } finally {
          _this.loading = false;
        }
      })();
    ...
    onRemove() {
      ...
      return asyncToGenerator_default()(function* () {
        if (_this2.toDelID !== -1) {
          try {
            const resp = yield Category.deleteCategory(_this2.toDelID);

            _this2.showNotif(true, "Successfully removed category."); // Remove from list and Reset
...
// CONCATENATED MODULE: ./src/pages/categories/Index.vue?vue&type=script&lang=js&
 /* harmony default export */ var categories_Indexvue_type_script_lang_js_ = (Indexvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/pages/categories/Index.vue?vue&type=style&index=0&id=b7444de4&lang=scss&scoped=true&
var Indexvue_type_style_index_0_id_b7444de4_lang_scss_scoped_true_ = __webpack_require__("d93f");

// EXTERNAL MODULE: ./src/pages/categories/Index.vue?vue&type=style&index=1&lang=scss&
var Indexvue_type_style_index_1_lang_scss_ = __webpack_require__("d0cd");
...
// CONCATENATED MODULE: ./src/pages/categories/Index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  categories_Indexvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_b7444de4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("f5e5");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_b7444de4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_b7444de4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_2_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_2_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_2_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_2_3_node_modules_quasar_app_lib_webpack_loader_quasar_scss_variables_js_node_modules_quasar_app_lib_webpack_loader_auto_import_client_js_kebab_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_style_index_0_id_b7444de4_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//# sourceMappingURL=8.18a5ce07.js.map